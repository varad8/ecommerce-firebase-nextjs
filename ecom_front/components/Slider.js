...
export default function SliderCard({ sliderimage }) {
  useEffect(() => {
  ...
  return (
    <>
      ...
      <div className="relative w-full h-72 overflow-hidden bg-white  shadow-sm glide-06 shadow-slate-200">
        {/*    <!-- Slides --> */}
          ...
          <ul className="whitespace-no-wrap flex-no-wrap [backface-visibility: hidden] [transform-style: preserve-3d] [touch-action: pan-Y] [will-change: transform] relative flex w-full overflow-hidden p-0">
            {sliderimage.images.map((image, index) => (
              <li key={index}>
                <img
                  src={image}
                  className="w-full max-w-full object-center object-fill h-72 m-auto"
