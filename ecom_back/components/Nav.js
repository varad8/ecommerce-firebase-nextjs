  ...
  return (
    <aside
      className={
        ...
        " top-0 text-gray-500 p-4 fixed w-full shadow-lg  bg-bgGray min-h-screen  md:static md:w-auto  transition-all"
      }
    >
      ...
      <nav className="flex flex-col gap-2">
        ...
        <Link
          href={"/slidermain"}
          className={
            pathname.includes("/slidermain") ? activeLink : inactiveLink
          }
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            ...
            stroke="currentColor"
            className={
              pathname.includes("/slidermain") ? activeIcon : inactiveIcon
            }
          >
            <path
              strokeLinecap="round"
